...
`,i=()=>({colors:o}),s=({children:e})=>React.createElement(React.Fragment,null,React.createElement(a,{key:"neko-ui-styles"}),e),l=({children:e})=>React.createElement(s,null,e)},1863(e,t,n){"use strict";n.d(t,{M:()=>f});var r=n(1594),o=n.n(r),a=n(390),i=n.n(a),s=n(5396),l=n(9018),c=n(8074),u=n(6038);function d(){return d=Object.assign?Object.assign.bind():function(e){for(var t=1;t<arguments.length;t++){var n=arguments[t];for(var r in n)({}).hasOwnProperty.call(n,r)&&(e[r]=n[r])}return e},d.apply(null,arguments)}const p=(0,s.Ay)((e=>{let{className:t="primary",variant:n,disabled:a=!1,icon:i=null,color:s=null,onClick:p=(()=>{}),onStopClick:h=null,rounded:f,isBusy:m=!1,busy:g=!1,spinning:y=!1,disabledColor:b=null,busyText:v,hideBusyIcon:k=!1,busyIconSize:x,requirePro:w=!1,isPro:C=!1,small:E,large:A,width:S,height:O,fullWidth:M,startTime:R=null,progress:_=null,ai:$=!1,children:z,...N}=e;const j=g||m;o().useEffect((()=>{m&&console.log('NekoButton: The "isBusy" prop is deprecated. Please use "busy" instead.')}),[m]);const T=o().useRef(null),P=o().useRef(null),[I,L]=o().useState(null);o().useLayoutEffect((()=>{T.current&&!P.current&&(P.current=T.current.offsetWidth)})),o().useEffect((()=>{if(!j&&!h){const e=setTimeout((()=>{L(null)}),300);return()=>clearTimeout(e)}}),[j,h]),o().useEffect((()=>{t&&["primary","primary-block","secondary","danger","success","warning","header"].includes(t)&&!n&&console.warn(`NekoButton: Using 'className' prop for button variants is deprecated. Please use 'variant' prop instead. Found className="${t}"`)}),[t,n]);const F=n||(["primary","primary-block","secondary","danger","success","warning","header"].includes(t)?t:"primary"),q=t&&!["primary","primary-block","secondary","danger","success","warning","header"].includes(t)?t:"";o().useEffect((()=>{$&&(n||["secondary","danger","success","warning","header"].includes(F))&&console.warn('NekoButton: The "ai" property doesn\'t need a variant. The ai styling will override the variant styling.')}),[$,n,F]);const D=a||w&&!C,B=!!i,W=w&&!C,H=!!h&&j,U=(0,r.useMemo)((()=>{let e="number"==typeof S?S:30;return E&&(e*=.8),A&&(e*=1.3),"header"===F||t&&t.includes("header")?20:f?e-12:e-14}),[S,f,E,A,F,t]),[Q,K]=(0,r.useState)(null);(0,u.$$)((()=>K(new Date)),R?1e3:null),(0,r.useEffect)((()=>{R||K(null)}),[R]);const V=(0,r.useMemo)((()=>{if(!R||!Q)return null;const e=Math.floor((Q-R)/1e3),t=e%60;return`${Math.floor(e/60).toString().padStart(2,"0")}:${t.toString().padStart(2,"0")}`}),[Q,R]),G=(0,u.gR)("neko-button",F,q,{"has-icon":B},{"custom-color":s},{small:E},{large:A},{rounded:f},{busy:j},{"is-pro":W},{full:M},{"has-stop":H},{ai:$});return o().createElement("button",d({ref:T,type:"button",className:G,onClick:e=>{if(!j&&T.current){const e=h&&P.current?P.current:T.current.offsetWidth;L(e)}D||H||p(),e.stopPropagation(),e.preventDefault()},disabled:D&&!(j&&H),style:j&&I?{minWidth:`${I}px`,width:`${I}px`}:void 0},N),j&&null!==_&&_>0&&o().createElement("div",{className:"progress-bar",style:{width:`${_}%`}}),j&&!H&&!k&&o().createElement("div",{className:"busy-wrapper"},o().createElement("div",{className:"busy-icon"},o().createElement(l.z,{raw:!0,icon:"sync",width:16,height:16})),null!==_&&_>=0&&o().createElement("span",{className:"progress-percentage"},Math.round(_),"%"),V&&o().createElement("span",{className:"chrono-time"},V)),!j&&!H&&o().createElement("div",{className:"normal-content"},B&&!f&&!!z&&o().createElement("div",{className:"icon-section"},o().createElement(l.z,{raw:!0,icon:i,width:U,height:U,spinning:y,strokeWidth:f&&E?3:void 0})),B&&!f&&!z&&o().createElement(l.z,{raw:!0,icon:i,width:U,height:U,spinning:y,style:{margin:"0 auto"},strokeWidth:f&&E?3:void 0}),B&&f&&o().createElement(l.z,{raw:!0,icon:i,width:U,height:U,spinning:y,style:{margin:"0 auto"},strokeWidth:f&&E?3:void 0}),!!z&&o().createElement("span",{className:B&&!f?"button-text":""},z)),H&&o().createElement(o().Fragment,null,o().createElement("div",{className:"busy-icon"},o().createElement(l.z,{raw:!0,icon:"sync",width:16,height:16})),o().createElement("div",{className:"stop-section",onClick:e=>{e.stopPropagation(),h()}},o().createElement(l.z,{raw:!0,icon:"stop",width:"14",height:"14"}))),W&&o().createElement(c.K,{style:{marginLeft:"8px"}}))}))`
  position: relative;
  display: inline-flex;
  align-items: center;
 ...
 * See the LICENSE file in the root directory of this source tree.
 */
const _=(0,r.A)("database",[["ellipse",{cx:"12",cy:"5",rx:"9",ry:"3",key:"msslwz"}],["path",{d:"M3 5V19A9 3 0 0 0 21 19V5",key:"1wlel7"}],["path",{d:"M3 12A9 3 0 0 0 21 12",key:"mv7ke4"}]]),$=(0,r.A)("wrench",[["path",{d:"M14.7 6.3a1 1 0 0 0 0 1.4l1.6 1.6a1 1 0 0 0 1.4 0l3.106-3.105c.32-.322.863-.22.983.218a6 6 0 0 1-8.259 7.057l-7.91 7.91a1 1 0 0 1-2.999-3l7.91-7.91a6 6 0 0 1 7.057-8.259c.438.12.54.662.219.984z",key:"1ngwbx"}]]),z=(0,r.A)("settings",[["path",{d:"M9.671 4.136a2.34 2.34 0 0 1 4.659 0 2.34 2.34 0 0 0 3.319 1.915 2.34 2.34 0 0 1 2.33 4.033 2.34 2.34 0 0 0 0 3.831 2.34 2.34 0 0 1-2.33 4.033 2.34 2.34 0 0 0-3.319 1.915 2.34 2.34 0 0 1-4.659 0 2.34 2.34 0 0 0-3.32-1.915 2.34 2.34 0 0 1-2.33-4.033 2.34 2.34 0 0 0 0-3.831A2.34 2.34 0 0 1 6.35 6.051a2.34 2.34 0 0 0 3.319-1.915",key:"1i5ecw"}],["circle",{cx:"12",cy:"12",r:"3",key:"1v7zrd"}]]);var N=n(5067);
/**
 * @license lucide-react v0.542.0 - ISC
 *
 * This source code is licensed under the ISC license.
...
`,m=["disabled","ok","okOnClick","okDisabled","cancel","cancelOnClick","cancelDisabled"],g=e=>{const{className:t,style:n,contentStyle:a,title:i="",content:s="",contentWidth:c,customButtons:g=null,okOnEnter:y=!1,thumbnail:b,okButton:v={},cancelButton:k={},action:x=null,isOpen:w,children:C,customButtonsPosition:E="right",size:A="normal",fullSize:S=!1,...O}=e,M=A||(S?"full-size":"normal"),R="full-size"===M,_=(0,d.gR)("neko-modal",t,{large:"large"===M,larger:"larger"===M,"full-size":R,"custom-modal":n}),{label:$="OK",...z}=v,{label:N="Cancel",...j}=k;(0,r.useEffect)((()=>{const t=m.filter((t=>void 0!==e[t]));t.length&&console.warn(`[Deprecated] NekoUI: Button attributes ${t.join(", ")} are deprecated in NekoModal.\nPlease use: okButton={{ label, onClick, disabled }} and cancelButton={{ ... }}`,{props:e})}),[e]);const T=(0,r.useCallback)((({key:e})=>{"Enter"===e&&z.onClick&&z.onClick()}),[z]);(0,r.useEffect)((()=>{if(y&&w)return window.addEventListener("keyup",T),()=>window.removeEventListener("keyup",T)}),[y,w,T]);const P=C||o().createElement(f,{size:M,contentWidth:c},R&&i&&o().createElement("div",{className:"full-size-header"},o().createElement("p",{className:"title"},i),x&&o().createElement("div",{className:"button-group"},x)),!R&&i&&o().createElement("p",{className:"title"},i),o().createElement("div",{className:"content-container"},b&&o().createElement("div",{className:"thumbnail"},b),s&&o().createElement("div",{className:"content",style:a},s)),o().createElement("div",{className:"button-group"+(R?" full-size-footer":"")},o().createElement(o().Fragment,null,g&&"left"===E&&g,j.onClick&&o().createElement(u.M,p({className:"danger"},j),N),z.onClick&&o().createElement(u.M,z,$),g&&"right"===E&&g)));return o().createElement(o().Fragment,null,o().createElement(h,null),o().createElement(l(),p({ariaHideApp:!1,closeTimeoutMS:200,className:_,style:n,isOpen:w},O),P))},y=e=>o().createElement(g,e);y.propTypes={className:i().string,style:i().object,contentStyle:i().object,title:i().string,content:i().string,contentWidth:i().string,customButtons:i().object,okOnEnter:i().bool,thumbnail:i().element,okButton:i().object,cancelButton:i().object,action:i().element,size:i().oneOf(["normal","large","larger","full-size"]),fullSize:i().bool,isOpen:i().bool.isRequired}},5510(e,t,n){"use strict";n.d(t,{o:()=>_});var r=n(1594),o=n.n(r),a=n(390),i=n.n(a),s=n(5396),l=n(217),c=n(6104),u=n(4146),d=n(1796),p=n(4764),h=n(6038);var f=n(9018),m=n(3307),g=n(9649),y=n(6242),b=n(1863),v=n(4709),k=n(8865);const x=s.Ay.div`
  min-width: 160px;
  padding: 8px;
  border-radius: 8px;
  overflow: hidden;
 ...
 * See the LICENSE file in the root directory of this source tree.
 */
const r=(0,n(7927).A)("Lightbulb",[["path",{d:"M15 14c.2-1 .7-1.7 1.5-2.5 1-.9 1.5-2.2 1.5-3.5A6 6 0 0 0 6 8c0 1 .2 2.2 1.5 3.5.7.7 1.3 1.5 1.5 2.5",key:"1gvzjb"}],["path",{d:"M9 18h6",key:"x1upvd"}],["path",{d:"M10 22h4",key:"ceow96"}]])},4590(e,t,n){"use strict";n.d(t,{A:()=>r});
/**
 * @license lucide-react v0.454.0 - ISC
 *
 * This source code is licensed under the ISC license.
