...
const OSXHeader = ({ title, onClose, onMinimize, onMaximize, theme, showResize }) => {
  const isDarkMode = theme?.themeId === 'chatgpt';
  
  return (
    <div className="mwai-header mwai-header-osx">
