      ...
      <NekoWrapper>
        <NekoColumn fullWidth>
          ...
          <NekoTabs keepTabOnReload={true}>
                  ...
                  <NekoColumn minimal>
                    <NekoBlock busy={busy} title={i18n.CHATBOT.CHATBOT_BUILDER} className="primary" action={
                      ...
                      <StyledBuilderForm>
                        ...
                        <div className="mwai-builder-row" style={{ height: shortcodeParams.mode === 'chat' ? 76 : 'inherit' }}>
                          <div className="mwai-builder-col" style={{ height: '100%' }}>
                        ...
                        {isChat && (
                          <div className="mwai-builder-row">
                            <div className="mwai-builder-col" style={{ flex: 3 }}>
                              ...
                              <NekoSelect scrolldown id="model" name="model" value={shortcodeParams.model} description="" onChange={updateShortcodeParams}>
                            ...
                            <div className="mwai-builder-col" style={{ flex: 2 }}>
                              ...
                              <NekoCheckbox name="casually_fine_tuned" label="Yes" disabled={!isFineTuned} checked={shortcodeParams.casually_fine_tuned} value="1" onChange={updateShortcodeParams} />
                            </div>
                            <div className="mwai-builder-col" style={{ flex: 1 }}>
                        ...
                        {isChat && (
                          <div className="mwai-builder-row">
                            ...
                            <div className="mwai-builder-col" style={{ flex: 1 }}>
                              ...
                              <NekoInput id="max_sentences" name="max_sentences" step="1" min="1" max="512" value={shortcodeParams.max_sentences} onBlur={updateShortcodeParams} />
                            </div>
                            <div className="mwai-builder-col" style={{ flex: 1 }}>
                              <label>{i18n.COMMON.INPUT_MAXLENGTH}:</label>
                              <NekoInput id="text_input_maxlength" name="text_input_maxlength" step="1" min="1" max="512" value={shortcodeParams.text_input_maxlength} onBlur={updateShortcodeParams} />
                            </div>
                          </div>
                        )}
                        {isChat && (
                          <div className="mwai-builder-row">
                            <div className="mwai-builder-col">
                              ...
                              <NekoSelect scrolldown id="embeddings_index" name="embeddings_index" requirePro={true} isPro={isRegistered}
                                ...
                                <NekoOption key="" value="" label={"Disabled"} />
                              </NekoSelect>
                            </div>
                            <div className="mwai-builder-col">
                              <label>{i18n.COMMON.CONTENT_AWARE}:</label>
                              <NekoCheckbox name="content_aware" label="Yes" requirePro={true} isPro={isRegistered} checked={shortcodeParams.content_aware} value="1" onChange={updateShortcodeParams} />
                            </div>
                          </div>
                        )}
                      ...
                      <NekoCheckbox name="shortcode_chat_params_override" label={i18n.SETTINGS.SET_AS_DEFAULT_PARAMETERS} disabled={Object.keys(shortcodeParamsDiff).length < 1 && !shortcodeParamsOverride} value="1" checked={shortcodeParamsOverride} description={i18n.SETTINGS.SET_AS_DEFAULT_PARAMETERS_HELP} onChange={updateOption} />
                      <NekoCheckbox name="shortcode_chat_inject" label={i18n.SETTINGS.INJECT_DEFAULT_CHATBOT} value="1" checked={shortcodeChatInject} description={i18n.SETTINGS.INJECT_DEFAULT_CHATBOT_HELP} onChange={updateOption} />
                    </NekoBlock>
                  </NekoColumn>
                  <NekoColumn minimal>
                      ...
                      <StyledBuilderForm>
                        ...
                        <div className="mwai-builder-row">
                          <div className="mwai-builder-col" style={{ flex: 2 }}>
                            ...
                            <div style={{ display: 'flex' }}>
                              {chatIcons.map(x => (
                                <img key={x} style={{ marginRight: 2, cursor: 'pointer' }} width={24} height={24} src={`${pluginUrl}/images/${x}`} onClick={() => { updateShortcodeStyles(x, 'icon') }} />
                              ))}
                        ...
                        {isCustomURL && (
                          <div className="mwai-builder-row">
                            <div className="mwai-builder-col">
                              ...
                              <NekoInput id="icon" name="icon" value={chatIcon} onBlur={updateIcon} />
                            </div>
                          </div>
                        )}
                  ...
                  <NekoColumn minimal>
                    <StyledBuilderForm>
                      <NekoBlock className="primary" busy={busy} title="Limits" style={{ flex: 1 }} action={
                        ...
                        <NekoCheckbox name="enabled" label={i18n.STATISTICS.ENABLE_LIMITS} checked={limits?.enabled} value="1" onChange={updateLimits} />
                        <NekoSpacer />
                        ...
                        <div className="mwai-builder-row">
                          <div className="mwai-builder-col">
                            ...
                            <NekoInput
                              ...
                              value={limits?.[limitSection]?.credits}
                        ...
                        {limits?.[limitSection]?.credits === 0 && (
                          <p>Since there are no credits, the Message for No Credits Message with be displayed.</p>
                        )}
                        <div className="mwai-builder-row">
                          <div className="mwai-builder-col">
                          ...
                          <div className="mwai-builder-col">
                            ...
                            <NekoCheckbox name="isAbsolute" label="Yes" disabled={!limits?.enabled} checked={limits?.[limitSection]?.isAbsolute} value="1" onChange={limitSection === 'users' ? updateUserLimits : updateGuestLimits} />
                          </div>
                        </div>
                        ...
                        {limitSection === 'users' && (
                          <div className="mwai-builder-row">
                            <div className="mwai-builder-col">
                              ...
                              <NekoSelect scrolldown id="ignoredUsers" name="ignoredUsers" disabled={!limits?.enabled} value={limits?.users?.ignoredUsers} description="" onChange={updateUserLimits}>
            ...
            <NekoTab key="openai-status" title={
              accidentsPastDay > 0 ? (
                <>{i18n.COMMON.OPENAI_TAB}&nbsp;✅</>
              ) : (
                <>{i18n.COMMON.OPENAI_TAB}&nbsp;⚠️</>
              )
            }>
