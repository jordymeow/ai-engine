  ...
  const jsxAdminBarPlayground =
    <NekoSettings title={i18n.COMMON.PLAYGROUND}>
      <NekoCheckbox label={i18n.COMMON.ENABLE} value="1"
        ...
        onChange={(value) => {
          const newAdminBar = admin_bar.includes('playground') ? admin_bar.filter(v => v !== 'playground') : [...admin_bar, 'playground'];
  ...
  const jsxAdminBarGenerateContent =
    <NekoSettings title={i18n.COMMON.GENERATE_CONTENT}>
      <NekoCheckbox label={i18n.COMMON.ENABLE} value="1"
        ...
        onChange={(value) => {
          const newAdminBar = admin_bar.includes('content_generator') ? admin_bar.filter(v => v !== 'content_generator') : [...admin_bar, 'content_generator'];
          updateOption(newAdminBar, 'admin_bar');
        }} />
    </NekoSettings>;
  ...
  const jsxAdminBarGenerateImages =
    <NekoSettings title={i18n.COMMON.GENERATE_IMAGES}>
      <NekoCheckbox label={i18n.COMMON.ENABLE} value="1"
        ...
        onChange={(value) => {
          const newAdminBar = admin_bar.includes('images_generator') ? admin_bar.filter(v => v !== 'images_generator') : [...admin_bar, 'images_generator'];
          updateOption(newAdminBar, 'admin_bar');
        }} />
    </NekoSettings>;
  ...
  const jsxAdminBarSettings =
    <NekoSettings title={'AI Engine'}> 
      <NekoCheckbox label={i18n.COMMON.ENABLE} value="1"
        ...
        onChange={(value) => {  
          const newAdminBar = admin_bar.includes('settings') ? admin_bar.filter(v => v !== 'settings') : [...admin_bar, 'settings'];
          updateOption(newAdminBar, 'admin_bar');
        }} />
    </NekoSettings>;
