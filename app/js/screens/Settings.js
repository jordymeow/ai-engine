...
const Settings = () => {
  ...
  const isFineTuned = useMemo(() => isFineTunedModel(shortcodeParams.model), [shortcodeParams.model]);
  ...
  const contextHasContent = useMemo(() => shortcodeParams?.context?.includes('{CONTENT}'), [shortcodeParams]);
