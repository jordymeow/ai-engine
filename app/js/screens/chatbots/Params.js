            ...
            <NekoCollapsableCategories keepState="chatbotParams">
              ...
              <NekoCollapsableCategory title={i18n.COMMON.AI_MODEL}>
                <div className="mwai-builder-row">
                  ...
                  {currentModel?.tags?.includes('image') && (
                    <div className="mwai-builder-col" style={{ flex: 1 }}>
                  ...
                  {currentModel?.tags?.includes('vision') && (
                    <div className="mwai-builder-col" style={{ flex: 1 }}>
                  ...
                  {isAssistant && (
                    <div className="mwai-builder-col" style={{ flex: 1 }}>
                      ...
                      <NekoSelect
                        scrolldown
                        name="fileUpload"
                        value={shortcodeParams.fileUpload}
                        onChange={updateShortcodeParams}
                      >
                        <NekoOption value="" label="None" />
                ...
                {(shortcodeParams.window || !shortcodeParams.aiName) && (
                  ...
                  >
                    <div className="mwai-builder-row" style={{ marginTop: 0 }}>
                          ...
                          <NekoButton
                            ...
                            onClick={() => {
                              updateShortcodeParams(
                                `${pluginUrl}/images/chat-color-green.svg`,
                                'icon'
                              );
                            }}
                          >
                      ...
                      >
                        <img
                          style={{ marginRight: 0, paddingTop: 0 }}
                          width={48}
                          height={48}
                          src={`${previewIcon}`}
                        />
