...
const ChatbotParams = (props) => {
  ...
  const { completionModels, isFineTunedModel, getModel } = useModels(options, shortcodeParams.envId || null);
  ...
  }, [shortcodeParams.embeddingsIndex, shortcodeParams.embeddingsNamespace, environment]);
