...
const Embeddings = ({ options, updateOption }) => {
  ...
  useEffect(() => {
    setQueryParams({ ...queryParams, filters: {  envId: environmentId, search } });
  ...
  }, [mode, vectorsData, isBusy, embeddingsModel, environmentId, allModels, colors, busyFetchingVectors]);
