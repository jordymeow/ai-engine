...
/* harmony import */ var _neko_ui__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! @neko-ui */ "../neko-ui/src/container/Spacer.js");
...
var ContentGenerator = function ContentGenerator() {
  ...
  var _useState7 = useState(4),
    ...
    headingsCount = _useState8[0],
    setHeadingsCount = _useState8[1];
  var _useState9 = useState(DefaultHeadings),
    _useState10 = _slicedToArray(_useState9, 2),
    headings = _useState10[0],
    setHeadings = _useState10[1];
  var _useState11 = useState(2),
    _useState12 = _slicedToArray(_useState11, 2),
    paragraphsCount = _useState12[0],
    setParagraphsCount = _useState12[1];
  ...
  var _useState15 = useState(''),
    ...
    excerpt = _useState16[0],
    setExcerpt = _useState16[1];
  var _useState17 = useState('en'),
    _useState18 = _slicedToArray(_useState17, 2),
    language = _useState18[0],
    setLanguage = _useState18[1];
  var _useState19 = useState('informative'),
    _useState20 = _slicedToArray(_useState19, 2),
    writingStyle = _useState20[0],
    setWritingStyle = _useState20[1];
  var _useState21 = useState('neutral'),
    _useState22 = _slicedToArray(_useState21, 2),
    writingTone = _useState22[0],
    setWritingTone = _useState22[1];
  var _useState23 = useState(),
    _useState24 = _slicedToArray(_useState23, 2),
    promptForTopic = _useState24[0],
    setPromptForTopic = _useState24[1];
  var _useState25 = useState(),
    _useState26 = _slicedToArray(_useState25, 2),
    promptForHeadings = _useState26[0],
    setPromptForHeadings = _useState26[1];
  var _useState27 = useState(),
    _useState28 = _slicedToArray(_useState27, 2),
    promptForContent = _useState28[0],
    setPromptForContent = _useState28[1];
  var _useState29 = useState(),
    _useState30 = _slicedToArray(_useState29, 2),
    promptForExcerpt = _useState30[0],
    setPromptForExcerpt = _useState30[1];
  var _useState31 = useState(0.6),
    _useState32 = _slicedToArray(_useState31, 2),
    temperature = _useState32[0],
    setTemperature = _useState32[1];
  var _useState33 = useState(2048),
    _useState34 = _slicedToArray(_useState33, 2),
    maxTokens = _useState34[0],
    setMaxTokens = _useState34[1];
  ...
  var _useState37 = useState(false),
    ...
    showModelParams = _useState38[0],
    setShowModelParams = _useState38[1];
  var _useState39 = useState(false),
    _useState40 = _slicedToArray(_useState39, 2),
    showPrompts = _useState40[0],
    setShowPrompts = _useState40[1];
  var _useState41 = useState(),
    _useState42 = _slicedToArray(_useState41, 2),
    createdPostId = _useState42[0],
    setCreatedPostId = _useState42[1];
  var titleMessage = useMemo(function () {
    return getSeoMessage(title);
  }, [title]);
  useEffect(function () {
    if (topic) {
      setPromptForTopic("Write a title for an article about \"".concat(topic, "\". Should be between 40 and 60 characters. Do not use quotes around the title."));
    }
  }, [topic]);
  useEffect(function () {
    if (title) {
      ...
      setPromptForHeadings("Generate ".concat(headingsCount, " consecutive headings for an article about \"").concat(title, "\", in ").concat(humanLanguage, ". Style: ").concat(writingStyle, ". Tone: ").concat(writingTone, ".\n\nEach heading is between 40 and 60 characters.\n\nUse Markdown for the headings (## )."));
    }
  ...
  useEffect(function () {
    if (title && headings) {
      ...
      setPromptForContent("Write an article about \"".concat(title, "\" in ").concat(humanLanguage, ". The article is organized by the following headings:\n\n").concat(headings, "\n\nWrite ").concat(paragraphsCount, " paragraphs per heading.\n\nUse Markdown for formatting.\n\nAdd an introduction prefixed by \"===INTRO: \", and a conclusion prefixed by \"===OUTRO: \".\n\nStyle: ").concat(writingStyle, ". Tone: ").concat(writingTone, "."));
    }
  ...
  var onOneClickGenerate = /*#__PURE__*/function () {
    var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
      var text, _headings, _content;
      return _regeneratorRuntime().wrap(function _callee2$(_context2) {
        while (1) switch (_context2.prev = _context2.next) {
          case 0:
            setBusy(true);
            _context2.next = 3;
            return onSubmitPrompt(promptForTopic);
          case 3:
            text = _context2.sent;
            setBusy(false);
            if (!text) {
            ...
            setTitle(text);
            _context2.next = 9;
            return onSubmitPromptForHeadings();
          case 9:
            _headings = _context2.sent;
            if (!_headings) {
              _context2.next = 17;
              break;
            }
            _context2.next = 13;
            return onSubmitPromptForContent();
          case 13:
            _content = _context2.sent;
            if (!_content) {
              _context2.next = 17;
              break;
            }
    ...
    return function onOneClickGenerate() {
  ...
  return /*#__PURE__*/React.createElement(_neko_ui__WEBPACK_IMPORTED_MODULE_5__.NekoPage, {
  ...
  }, "Topic"), /*#__PURE__*/React.createElement(_neko_ui__WEBPACK_IMPORTED_MODULE_10__.NekoInput, {
    disabled: true,
    value: topic,
    onChange: setTopic
  ...
  }, "One-Click Generate"), /*#__PURE__*/React.createElement("div", {
    className: "information"
  }, "The Topic feature is coming soon! Add a topic followed by some keywords, and it will all be generated in one-click. Let me know if that interests you!")), /*#__PURE__*/React.createElement(StyledSidebar, {
    style: {
      marginBottom: 25
    }
  }, /*#__PURE__*/React.createElement("h2", {
  ...
  }, "Content Params"), /*#__PURE__*/React.createElement("label", null, "Language:"), /*#__PURE__*/React.createElement(_neko_ui__WEBPACK_IMPORTED_MODULE_12__.NekoSelect, {
    scrolldown: true,
    id: "language",
    name: "language",
    disabled: busy,
  ...
  })), /*#__PURE__*/React.createElement("label", null, "Writing style:"), /*#__PURE__*/React.createElement(_neko_ui__WEBPACK_IMPORTED_MODULE_12__.NekoSelect, {
    scrolldown: true,
    id: "writingStyle",
    name: "writingStyle",
    disabled: busy,
  ...
  })), /*#__PURE__*/React.createElement("label", null, "Writing tone:"), /*#__PURE__*/React.createElement(_neko_ui__WEBPACK_IMPORTED_MODULE_12__.NekoSelect, {
    scrolldown: true,
    id: "writingTone",
    name: "writingTone",
    disabled: busy,
    ...
    className: "information"
  }, "Advice: ", titleMessage), /*#__PURE__*/React.createElement(_neko_ui__WEBPACK_IMPORTED_MODULE_13__.NekoSpacer, {
    height: 5
  }), /*#__PURE__*/React.createElement(_CommonStyles__WEBPACK_IMPORTED_MODULE_6__.StyledTitleWithButton, null, /*#__PURE__*/React.createElement("h2", null, "Sections"), /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'flex',
      alignItems: 'center'
    }
  ...
  }, "# of Sections: "), /*#__PURE__*/React.createElement(_neko_ui__WEBPACK_IMPORTED_MODULE_12__.NekoSelect, {
    scrolldown: true,
    id: "headingsCount",
    disabled: !title || busy,
    style: {
  ...
  }, "Generate Sections"))), /*#__PURE__*/React.createElement(_neko_ui__WEBPACK_IMPORTED_MODULE_13__.NekoSpacer, {
    height: 5
  }), /*#__PURE__*/React.createElement(_neko_ui__WEBPACK_IMPORTED_MODULE_14__.NekoTextArea, {
    rows: 4,
    value: headings,
    onBlur: setHeadings
  }), /*#__PURE__*/React.createElement("div", {
    className: "information"
  }, "Add, rewrite, remove, or reorganize those sections as you wish before clicking \"Generate Content\". I recommend using Markdown."), /*#__PURE__*/React.createElement(_neko_ui__WEBPACK_IMPORTED_MODULE_13__.NekoSpacer, {
    height: 5
  }), /*#__PURE__*/React.createElement(_CommonStyles__WEBPACK_IMPORTED_MODULE_6__.StyledTitleWithButton, null, /*#__PURE__*/React.createElement("h2", null, "Content"), /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'flex',
      alignItems: 'center'
    }
  ...
  }, "# of Paragraphs per Section: "), /*#__PURE__*/React.createElement(_neko_ui__WEBPACK_IMPORTED_MODULE_12__.NekoSelect, {
    scrolldown: true,
    id: "paragraphsCount",
    disabled: !title || busy,
    style: {
  ...
  }, "Generate Content"))), /*#__PURE__*/React.createElement(_neko_ui__WEBPACK_IMPORTED_MODULE_13__.NekoSpacer, {
    height: 5
  }), /*#__PURE__*/React.createElement(_neko_ui__WEBPACK_IMPORTED_MODULE_14__.NekoTextArea, {
    rows: 18,
    value: content,
    ...
    className: "information"
  }, "You can modify the content before using \"Create Post\". Markdown is supported, and will be converted to HTML when the post is created."), /*#__PURE__*/React.createElement(_CommonStyles__WEBPACK_IMPORTED_MODULE_6__.StyledTitleWithButton, null, /*#__PURE__*/React.createElement("h2", null, "Excerpt"), /*#__PURE__*/React.createElement(_neko_ui__WEBPACK_IMPORTED_MODULE_11__.NekoButton, {
    disabled: !title,
    isBusy: busy,
    onClick: onSubmitPromptForExcerpt
  }, "Generate Excerpt")), /*#__PURE__*/React.createElement(_neko_ui__WEBPACK_IMPORTED_MODULE_14__.NekoTextArea, {
    value: excerpt,
    onBlur: setExcerpt,
    rows: 3
  ...
  }, /*#__PURE__*/React.createElement(_CommonStyles__WEBPACK_IMPORTED_MODULE_6__.StyledTitleWithButton, null, /*#__PURE__*/React.createElement("h2", null, "Model Params"), /*#__PURE__*/React.createElement(_neko_ui__WEBPACK_IMPORTED_MODULE_11__.NekoButton, {
    onClick: function onClick() {
      return setShowModelParams(!showModelParams);
    }
  }, showModelParams ? 'Hide' : 'Show')), showModelParams && /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("label", null, "Model:"), /*#__PURE__*/React.createElement(_neko_ui__WEBPACK_IMPORTED_MODULE_12__.NekoSelect, {
    id: "models",
    value: model,
    scrolldown: true,
    onChange: setModel
  ...
  })), /*#__PURE__*/React.createElement("label", null, "Temperature:"), /*#__PURE__*/React.createElement(_neko_ui__WEBPACK_IMPORTED_MODULE_10__.NekoInput, {
    id: "temperature",
    name: "temperature",
    value: temperature,
    type: "number",
  ...
  }), /*#__PURE__*/React.createElement("label", null, "Max Tokens:"), /*#__PURE__*/React.createElement(_neko_ui__WEBPACK_IMPORTED_MODULE_10__.NekoInput, {
    id: "maxTokens",
    name: "maxTokens",
    value: maxTokens,
    type: "number",
  ...
  }))), /*#__PURE__*/React.createElement(StyledSidebar, null, /*#__PURE__*/React.createElement(_CommonStyles__WEBPACK_IMPORTED_MODULE_6__.StyledTitleWithButton, null, /*#__PURE__*/React.createElement("h2", null, "Prompts"), /*#__PURE__*/React.createElement(_neko_ui__WEBPACK_IMPORTED_MODULE_11__.NekoButton, {
    onClick: function onClick() {
      return setShowPrompts(!showPrompts);
    }
  }, showPrompts ? 'Hide' : 'Show')), showPrompts && /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("p", null, "The prompts are automatically generated for you, but you can enhance them once the values are set."), /*#__PURE__*/React.createElement("label", null, "Prompt for ", /*#__PURE__*/React.createElement("b", null, "One-Click Generate")), /*#__PURE__*/React.createElement(_neko_ui__WEBPACK_IMPORTED_MODULE_14__.NekoTextArea, {
    disabled: !content || busy,
    value: promptForTopic,
    onChange: setPromptForTopic
  }), /*#__PURE__*/React.createElement("label", null, "Prompt for ", /*#__PURE__*/React.createElement("b", null, "Generate Sections")), /*#__PURE__*/React.createElement(_neko_ui__WEBPACK_IMPORTED_MODULE_14__.NekoTextArea, {
    disabled: busy,
    value: promptForHeadings,
    onChange: setPromptForHeadings
  }), /*#__PURE__*/React.createElement("label", null, "Prompt for ", /*#__PURE__*/React.createElement("b", null, "Generate Content")), /*#__PURE__*/React.createElement(_neko_ui__WEBPACK_IMPORTED_MODULE_14__.NekoTextArea, {
    disabled: busy,
    value: promptForContent,
    onChange: setPromptForContent
  }), /*#__PURE__*/React.createElement("label", null, "Prompt for ", /*#__PURE__*/React.createElement("b", null, "Generate Excerpt")), /*#__PURE__*/React.createElement(_neko_ui__WEBPACK_IMPORTED_MODULE_14__.NekoTextArea, {
    disabled: !content || busy,
    value: promptForExcerpt,
    onChange: setPromptForExcerpt
  }))))), /*#__PURE__*/React.createElement(_neko_ui__WEBPACK_IMPORTED_MODULE_15__.NekoModal, {
...
/***/ "./app/js/components/FineTuning.js":
/*!*****************************************!*\
  !*** ./app/js/components/FineTuning.js ***!
  \*****************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _neko_ui__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! @neko-ui */ "../neko-ui/src/misc/UploadDropArea.js");
/* harmony import */ var _neko_ui__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! @neko-ui */ "../neko-ui/src/table/Table.js");
/* harmony import */ var _neko_ui__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! @neko-ui */ "../neko-ui/src/misc/Paging.js");
/* harmony import */ var _neko_ui__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! @neko-ui */ "../neko-ui/src/container/Spacer.js");
...
var FineTuning = function FineTuning(_ref5) {
  var _fineTuneRows$length, _fileRows$length;
  ...
  var _useState9 = useState(true),
    _useState10 = _slicedToArray(_useState9, 2),
    isModeTrain = _useState10[0],
    setIsModeTrain = _useState10[1];
  var _useModels = (0,_helpers__WEBPACK_IMPORTED_MODULE_8__.useModels)(options),
    models = _useModels.models,
    model = _useModels.model,
    setModel = _useModels.setModel;
  var _useState11 = useState('meow'),
    _useState12 = _slicedToArray(_useState11, 2),
    suffix = _useState12[0],
    setSuffix = _useState12[1];
  ...
  var _useState13 = useState(true),
    _useState14 = _slicedToArray(_useState13, 2),
    hasStorageBackup = _useState14[0],
    setHasStorageBackup = _useState14[1];
  ...
  var _useState17 = useState([]),
    _useState18 = _slicedToArray(_useState17, 2),
    builderData = _useState18[0],
    setBuilderData = _useState18[1];
  ...
  var onStartFineTune = /*#__PURE__*/function () {
    var _ref8 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee5() {
      var currentFile, currentSuffix, rawModel, res;
      return _regeneratorRuntime().wrap(function _callee5$(_context5) {
        while (1) switch (_context5.prev = _context5.next) {
          case 0:
            ...
            setBusyAction(true);
            //console.log({ currentFile, currentModel, currentSuffix });
            _context5.next = 6;
  ...
  var builderRows = useMemo(function () {
    ...
    return chunkOfBuilderData === null || chunkOfBuilderData === void 0 ? void 0 : chunkOfBuilderData.map(function (x) {
      ...
      var isValidPrompt = (_x$prompt = x.prompt) === null || _x$prompt === void 0 ? void 0 : _x$prompt.endsWith(defaultPromptEnding);
      var isValidCompletion = (_x$completion = x.completion) === null || _x$completion === void 0 ? void 0 : _x$completion.endsWith(defaultCompletionEnding);
      return {
        row: currentLine,
  ...
  var ref = useRef(null);
  return /*#__PURE__*/React.createElement(_neko_ui__WEBPACK_IMPORTED_MODULE_10__.NekoContainer, {
    style: {
      margin: 10
    }
  }, /*#__PURE__*/React.createElement("div", {
    ...
    className: "primary"
  }, "Upload to OpenAI")), /*#__PURE__*/React.createElement("div", {
    style: {
      flex: 'auto'
    }
  }), /*#__PURE__*/React.createElement(_neko_ui__WEBPACK_IMPORTED_MODULE_14__.NekoUploadDropArea, {
    ref: ref,
  ...
  }, "Import File")))), isModeTrain && section === 'finetunes' && /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("p", null, "The AI models you have fine-tuned. To create more, visit ", /*#__PURE__*/React.createElement("b", null, "Datasets"), "."), /*#__PURE__*/React.createElement(_neko_ui__WEBPACK_IMPORTED_MODULE_15__.NekoTable, {
    ...
    disabled: true,
    onClick: function onClick() {
      return alert("Coming soon! ✌️");
    }
  }, "Generate Entries"), /*#__PURE__*/React.createElement(_neko_ui__WEBPACK_IMPORTED_MODULE_6__.NekoButton, {
    disabled: !totalRows,
    className: "secondary",
    onClick: onFormatWithDefaults
  }, "Format with Defaults"), /*#__PURE__*/React.createElement(_neko_ui__WEBPACK_IMPORTED_MODULE_6__.NekoButton, {
    disabled: !totalRows,
    className: "secondary",
    style: {
      marginLeft: 5
  ...
  }), /*#__PURE__*/React.createElement(_neko_ui__WEBPACK_IMPORTED_MODULE_16__.NekoPaging, {
    currentPage: currentPage,
    limit: rowsPerPage,
    total: totalRows,
    onCurrentPageChanged: setCurrentPage,
    onClick: setCurrentPage
  })), /*#__PURE__*/React.createElement(_neko_ui__WEBPACK_IMPORTED_MODULE_17__.NekoSpacer, {
    height: 20
  }), /*#__PURE__*/React.createElement(_neko_ui__WEBPACK_IMPORTED_MODULE_15__.NekoTable, {
    alternateRowColor: true,
    busy: busyAction,
    data: builderRows,
  ...
  }), /*#__PURE__*/React.createElement("p", null, /*#__PURE__*/React.createElement("b", null, "Notes:")), /*#__PURE__*/React.createElement("p", null, "\u2022 The prompt and the completion should both end with their own special endings. By default, it is ", /*#__PURE__*/React.createElement("b", null, "\\n\\n===\\n\\n"), " for the prompt, and ", /*#__PURE__*/React.createElement("b", null, "\\n\\n"), " for the completion. The icon \u2705 will be shown next to the prompt and/or completion when this format has been validated, and the ending will be hidden for clarity. I refer to this format (and models trained on it) by the term of ", /*#__PURE__*/React.createElement("b", null, "Casually Fine Tuned"), "."), /*#__PURE__*/React.createElement("p", null, "\u2022 ", /*#__PURE__*/React.createElement("b", null, "\\n"), " is a line break. You can add line breaks by using ", /*#__PURE__*/React.createElement("b", null, "SHIFT+ENTER"), " while editing."), /*#__PURE__*/React.createElement("p", null, "\u2022 The ", /*#__PURE__*/React.createElement("b", null, "Format with Defaults"), " button will add the ", /*#__PURE__*/React.createElement("i", null, "Casually Fine Tuned"), " endings format to the prompt and completion, if they are missing."), /*#__PURE__*/React.createElement("p", null, "\u2022 If you need the chatbot to work with a ", /*#__PURE__*/React.createElement("b", null, "Casually Fined Tuned"), " model, you can add ", /*#__PURE__*/React.createElement("i", null, "casuallyFineTuned=\"true\""), "  in the parameter for the shortcode.")), /*#__PURE__*/React.createElement(_neko_ui__WEBPACK_IMPORTED_MODULE_18__.NekoModal, {
    ...
    content: /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("p", null, "Exciting! \uD83C\uDFB5 You are about to create your own new model, based on your dataset. You simply need to select a base model, and optionally, to modify the ", /*#__PURE__*/React.createElement("a", {
      ...
      target: "_blank"
    }, "OpenAI pricing"), " about fine-tuning.")), /*#__PURE__*/React.createElement("label", null, "Base model:"), /*#__PURE__*/React.createElement(_neko_ui__WEBPACK_IMPORTED_MODULE_17__.NekoSpacer, {
      height: 5
    }), /*#__PURE__*/React.createElement(_neko_ui__WEBPACK_IMPORTED_MODULE_19__.NekoSelect, {
      id: "models",
      value: model,
      scrolldown: true,
      onChange: setModel
      ...
      return /*#__PURE__*/React.createElement(_neko_ui__WEBPACK_IMPORTED_MODULE_19__.NekoOption, {
        value: x.id,
        label: x["short"] ? x["short"] : x.name
      });
    })), /*#__PURE__*/React.createElement(_neko_ui__WEBPACK_IMPORTED_MODULE_17__.NekoSpacer, {
      height: 5
    }), /*#__PURE__*/React.createElement("small", null, "For now, the hyperparameters can't be modified - they are set automatically by OpenAI."), /*#__PURE__*/React.createElement(_neko_ui__WEBPACK_IMPORTED_MODULE_17__.NekoSpacer, {
      height: 10
    }), /*#__PURE__*/React.createElement("label", null, "Suffix (for new model name):"), /*#__PURE__*/React.createElement(_neko_ui__WEBPACK_IMPORTED_MODULE_17__.NekoSpacer, {
      height: 5
...
var ImageGenerator = function ImageGenerator() {
  ...
  }, "Add to Media Library"), /*#__PURE__*/React.createElement(_neko_ui__WEBPACK_IMPORTED_MODULE_9__.NekoButton, {
    fullWidth: true,
    style: {
      marginLeft: 0,
      marginTop: 7
  ...
  }, "Download"), currentCreatedMediaId && /*#__PURE__*/React.createElement(_neko_ui__WEBPACK_IMPORTED_MODULE_11__.NekoMessageSuccess, {
    style: {
      fontSize: 13,
      padding: '10px 5px'
    }
...
var Dashboard = function Dashboard() {
  ...
  var _useState17 = useState(templates[2]),
    _useState18 = _slicedToArray(_useState17, 2),
    template = _useState18[0],
    setTemplate = _useState18[1];
  var _useState19 = useState(''),
    _useState20 = _slicedToArray(_useState19, 2),
    stopSequence = _useState20[0],
    setStopSequence = _useState20[1];
  var _useState21 = useState(2048),
    _useState22 = _slicedToArray(_useState21, 2),
    maxTokens = _useState22[0],
    setMaxTokens = _useState22[1];
  ...
  var onResetPrompt = function onResetPrompt() {
  ...
  }, "Reset"), /*#__PURE__*/React.createElement(_neko_ui__WEBPACK_IMPORTED_MODULE_12__.NekoButton, {
    onClick: function onClick() {
      onSubmitPrompt();
    },
    disabled: busy,
  ...
  }), /*#__PURE__*/React.createElement("label", null, "Max Tokens:"), /*#__PURE__*/React.createElement(_neko_ui__WEBPACK_IMPORTED_MODULE_1__.NekoInput, {
    id: "maxTokens",
    name: "maxTokens",
    value: maxTokens,
    type: "number",
    onBlur: function onBlur(value) {
      return setMaxTokens(parseInt(value));
    },
  ...
  }), /*#__PURE__*/React.createElement("label", null, "Stop Sequence:"), /*#__PURE__*/React.createElement(_neko_ui__WEBPACK_IMPORTED_MODULE_1__.NekoInput, {
    id: "stopSequence",
    name: "stopSequence",
    value: stopSequence,
    type: "text",
    onChange: setStopSequence,
    onBlur: setStopSequence,
    description: /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("span", null, "The sequence of tokens that will cause the model to stop generating text. You absolutely need this with your own models."))
  })), /*#__PURE__*/React.createElement(StyledSidebar, {
    style: {
      marginTop: 20
    }
...
/* harmony import */ var _neko_ui__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! @neko-ui */ "../neko-ui/src/container/Page.js");
/* harmony import */ var _neko_ui__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! @neko-ui */ "../neko-ui/src/container/Wrapper.js");
/* harmony import */ var _neko_ui__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! @neko-ui */ "../neko-ui/src/container/Container.js");
/* harmony import */ var _neko_ui__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! @neko-ui */ "../neko-ui/src/tabs/Tabs.js");
/* harmony import */ var _neko_ui__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! @neko-ui */ "../neko-ui/src/container/Block.js");
...
/* harmony import */ var _neko_ui__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @neko-ui */ "../neko-ui/src/helpers.js");
/* harmony import */ var _app_settings__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @app/settings */ "./app/js/settings.js");
/* harmony import */ var _constants__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../constants */ "./app/js/constants.js");
/* harmony import */ var _helpers__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../helpers */ "./app/js/helpers.js");
/* harmony import */ var _CommonStyles__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./CommonStyles */ "./app/js/components/CommonStyles.js");
/* harmony import */ var _FineTuning__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! ./FineTuning */ "./app/js/components/FineTuning.js");
function _typeof(obj) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (obj) { return typeof obj; } : function (obj) { return obj && "function" == typeof Symbol && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }, _typeof(obj); }
var _templateObject;
function _regeneratorRuntime() { "use strict"; /*! regenerator-runtime -- Copyright (c) 2014-present, Facebook, Inc. -- license (MIT): https://github.com/facebook/regenerator/blob/main/LICENSE */ _regeneratorRuntime = function _regeneratorRuntime() { return exports; }; var exports = {}, Op = Object.prototype, hasOwn = Op.hasOwnProperty, defineProperty = Object.defineProperty || function (obj, key, desc) { obj[key] = desc.value; }, $Symbol = "function" == typeof Symbol ? Symbol : {}, iteratorSymbol = $Symbol.iterator || "@@iterator", asyncIteratorSymbol = $Symbol.asyncIterator || "@@asyncIterator", toStringTagSymbol = $Symbol.toStringTag || "@@toStringTag"; function define(obj, key, value) { return Object.defineProperty(obj, key, { value: value, enumerable: !0, configurable: !0, writable: !0 }), obj[key]; } try { define({}, ""); } catch (err) { define = function define(obj, key, value) { return obj[key] = value; }; } function wrap(innerFn, outerFn, self, tryLocsList) { var protoGenerator = outerFn && outerFn.prototype instanceof Generator ? outerFn : Generator, generator = Object.create(protoGenerator.prototype), context = new Context(tryLocsList || []); return defineProperty(generator, "_invoke", { value: makeInvokeMethod(innerFn, self, context) }), generator; } function tryCatch(fn, obj, arg) { try { return { type: "normal", arg: fn.call(obj, arg) }; } catch (err) { return { type: "throw", arg: err }; } } exports.wrap = wrap; var ContinueSentinel = {}; function Generator() {} function GeneratorFunction() {} function GeneratorFunctionPrototype() {} var IteratorPrototype = {}; define(IteratorPrototype, iteratorSymbol, function () { return this; }); var getProto = Object.getPrototypeOf, NativeIteratorPrototype = getProto && getProto(getProto(values([]))); NativeIteratorPrototype && NativeIteratorPrototype !== Op && hasOwn.call(NativeIteratorPrototype, iteratorSymbol) && (IteratorPrototype = NativeIteratorPrototype); var Gp = GeneratorFunctionPrototype.prototype = Generator.prototype = Object.create(IteratorPrototype); function defineIteratorMethods(prototype) { ["next", "throw", "return"].forEach(function (method) { define(prototype, method, function (arg) { return this._invoke(method, arg); }); }); } function AsyncIterator(generator, PromiseImpl) { function invoke(method, arg, resolve, reject) { var record = tryCatch(generator[method], generator, arg); if ("throw" !== record.type) { var result = record.arg, value = result.value; return value && "object" == _typeof(value) && hasOwn.call(value, "__await") ? PromiseImpl.resolve(value.__await).then(function (value) { invoke("next", value, resolve, reject); }, function (err) { invoke("throw", err, resolve, reject); }) : PromiseImpl.resolve(value).then(function (unwrapped) { result.value = unwrapped, resolve(result); }, function (error) { return invoke("throw", error, resolve, reject); }); } reject(record.arg); } var previousPromise; defineProperty(this, "_invoke", { value: function value(method, arg) { function callInvokeWithMethodAndArg() { return new PromiseImpl(function (resolve, reject) { invoke(method, arg, resolve, reject); }); } return previousPromise = previousPromise ? previousPromise.then(callInvokeWithMethodAndArg, callInvokeWithMethodAndArg) : callInvokeWithMethodAndArg(); } }); } function makeInvokeMethod(innerFn, self, context) { var state = "suspendedStart"; return function (method, arg) { if ("executing" === state) throw new Error("Generator is already running"); if ("completed" === state) { if ("throw" === method) throw arg; return doneResult(); } for (context.method = method, context.arg = arg;;) { var delegate = context.delegate; if (delegate) { var delegateResult = maybeInvokeDelegate(delegate, context); if (delegateResult) { if (delegateResult === ContinueSentinel) continue; return delegateResult; } } if ("next" === context.method) context.sent = context._sent = context.arg;else if ("throw" === context.method) { if ("suspendedStart" === state) throw state = "completed", context.arg; context.dispatchException(context.arg); } else "return" === context.method && context.abrupt("return", context.arg); state = "executing"; var record = tryCatch(innerFn, self, context); if ("normal" === record.type) { if (state = context.done ? "completed" : "suspendedYield", record.arg === ContinueSentinel) continue; return { value: record.arg, done: context.done }; } "throw" === record.type && (state = "completed", context.method = "throw", context.arg = record.arg); } }; } function maybeInvokeDelegate(delegate, context) { var methodName = context.method, method = delegate.iterator[methodName]; if (undefined === method) return context.delegate = null, "throw" === methodName && delegate.iterator["return"] && (context.method = "return", context.arg = undefined, maybeInvokeDelegate(delegate, context), "throw" === context.method) || "return" !== methodName && (context.method = "throw", context.arg = new TypeError("The iterator does not provide a '" + methodName + "' method")), ContinueSentinel; var record = tryCatch(method, delegate.iterator, context.arg); if ("throw" === record.type) return context.method = "throw", context.arg = record.arg, context.delegate = null, ContinueSentinel; var info = record.arg; return info ? info.done ? (context[delegate.resultName] = info.value, context.next = delegate.nextLoc, "return" !== context.method && (context.method = "next", context.arg = undefined), context.delegate = null, ContinueSentinel) : info : (context.method = "throw", context.arg = new TypeError("iterator result is not an object"), context.delegate = null, ContinueSentinel); } function pushTryEntry(locs) { var entry = { tryLoc: locs[0] }; 1 in locs && (entry.catchLoc = locs[1]), 2 in locs && (entry.finallyLoc = locs[2], entry.afterLoc = locs[3]), this.tryEntries.push(entry); } function resetTryEntry(entry) { var record = entry.completion || {}; record.type = "normal", delete record.arg, entry.completion = record; } function Context(tryLocsList) { this.tryEntries = [{ tryLoc: "root" }], tryLocsList.forEach(pushTryEntry, this), this.reset(!0); } function values(iterable) { if (iterable) { var iteratorMethod = iterable[iteratorSymbol]; if (iteratorMethod) return iteratorMethod.call(iterable); if ("function" == typeof iterable.next) return iterable; if (!isNaN(iterable.length)) { var i = -1, next = function next() { for (; ++i < iterable.length;) if (hasOwn.call(iterable, i)) return next.value = iterable[i], next.done = !1, next; return next.value = undefined, next.done = !0, next; }; return next.next = next; } } return { next: doneResult }; } function doneResult() { return { value: undefined, done: !0 }; } return GeneratorFunction.prototype = GeneratorFunctionPrototype, defineProperty(Gp, "constructor", { value: GeneratorFunctionPrototype, configurable: !0 }), defineProperty(GeneratorFunctionPrototype, "constructor", { value: GeneratorFunction, configurable: !0 }), GeneratorFunction.displayName = define(GeneratorFunctionPrototype, toStringTagSymbol, "GeneratorFunction"), exports.isGeneratorFunction = function (genFun) { var ctor = "function" == typeof genFun && genFun.constructor; return !!ctor && (ctor === GeneratorFunction || "GeneratorFunction" === (ctor.displayName || ctor.name)); }, exports.mark = function (genFun) { return Object.setPrototypeOf ? Object.setPrototypeOf(genFun, GeneratorFunctionPrototype) : (genFun.__proto__ = GeneratorFunctionPrototype, define(genFun, toStringTagSymbol, "GeneratorFunction")), genFun.prototype = Object.create(Gp), genFun; }, exports.awrap = function (arg) { return { __await: arg }; }, defineIteratorMethods(AsyncIterator.prototype), define(AsyncIterator.prototype, asyncIteratorSymbol, function () { return this; }), exports.AsyncIterator = AsyncIterator, exports.async = function (innerFn, outerFn, self, tryLocsList, PromiseImpl) { void 0 === PromiseImpl && (PromiseImpl = Promise); var iter = new AsyncIterator(wrap(innerFn, outerFn, self, tryLocsList), PromiseImpl); return exports.isGeneratorFunction(outerFn) ? iter : iter.next().then(function (result) { return result.done ? result.value : iter.next(); }); }, defineIteratorMethods(Gp), define(Gp, toStringTagSymbol, "Generator"), define(Gp, iteratorSymbol, function () { return this; }), define(Gp, "toString", function () { return "[object Generator]"; }), exports.keys = function (val) { var object = Object(val), keys = []; for (var key in object) keys.push(key); return keys.reverse(), function next() { for (; keys.length;) { var key = keys.pop(); if (key in object) return next.value = key, next.done = !1, next; } return next.done = !0, next; }; }, exports.values = values, Context.prototype = { constructor: Context, reset: function reset(skipTempReset) { if (this.prev = 0, this.next = 0, this.sent = this._sent = undefined, this.done = !1, this.delegate = null, this.method = "next", this.arg = undefined, this.tryEntries.forEach(resetTryEntry), !skipTempReset) for (var name in this) "t" === name.charAt(0) && hasOwn.call(this, name) && !isNaN(+name.slice(1)) && (this[name] = undefined); }, stop: function stop() { this.done = !0; var rootRecord = this.tryEntries[0].completion; if ("throw" === rootRecord.type) throw rootRecord.arg; return this.rval; }, dispatchException: function dispatchException(exception) { if (this.done) throw exception; var context = this; function handle(loc, caught) { return record.type = "throw", record.arg = exception, context.next = loc, caught && (context.method = "next", context.arg = undefined), !!caught; } for (var i = this.tryEntries.length - 1; i >= 0; --i) { var entry = this.tryEntries[i], record = entry.completion; if ("root" === entry.tryLoc) return handle("end"); if (entry.tryLoc <= this.prev) { var hasCatch = hasOwn.call(entry, "catchLoc"), hasFinally = hasOwn.call(entry, "finallyLoc"); if (hasCatch && hasFinally) { if (this.prev < entry.catchLoc) return handle(entry.catchLoc, !0); if (this.prev < entry.finallyLoc) return handle(entry.finallyLoc); } else if (hasCatch) { if (this.prev < entry.catchLoc) return handle(entry.catchLoc, !0); } else { if (!hasFinally) throw new Error("try statement without catch or finally"); if (this.prev < entry.finallyLoc) return handle(entry.finallyLoc); } } } }, abrupt: function abrupt(type, arg) { for (var i = this.tryEntries.length - 1; i >= 0; --i) { var entry = this.tryEntries[i]; if (entry.tryLoc <= this.prev && hasOwn.call(entry, "finallyLoc") && this.prev < entry.finallyLoc) { var finallyEntry = entry; break; } } finallyEntry && ("break" === type || "continue" === type) && finallyEntry.tryLoc <= arg && arg <= finallyEntry.finallyLoc && (finallyEntry = null); var record = finallyEntry ? finallyEntry.completion : {}; return record.type = type, record.arg = arg, finallyEntry ? (this.method = "next", this.next = finallyEntry.finallyLoc, ContinueSentinel) : this.complete(record); }, complete: function complete(record, afterLoc) { if ("throw" === record.type) throw record.arg; return "break" === record.type || "continue" === record.type ? this.next = record.arg : "return" === record.type ? (this.rval = this.arg = record.arg, this.method = "return", this.next = "end") : "normal" === record.type && afterLoc && (this.next = afterLoc), ContinueSentinel; }, finish: function finish(finallyLoc) { for (var i = this.tryEntries.length - 1; i >= 0; --i) { var entry = this.tryEntries[i]; if (entry.finallyLoc === finallyLoc) return this.complete(entry.completion, entry.afterLoc), resetTryEntry(entry), ContinueSentinel; } }, "catch": function _catch(tryLoc) { for (var i = this.tryEntries.length - 1; i >= 0; --i) { var entry = this.tryEntries[i]; if (entry.tryLoc === tryLoc) { var record = entry.completion; if ("throw" === record.type) { var thrown = record.arg; resetTryEntry(entry); } return thrown; } } throw new Error("illegal catch attempt"); }, delegateYield: function delegateYield(iterable, resultName, nextLoc) { return this.delegate = { iterator: values(iterable), resultName: resultName, nextLoc: nextLoc }, "next" === this.method && (this.arg = undefined), ContinueSentinel; } }, exports; }
function ownKeys(object, enumerableOnly) { var keys = Object.keys(object); if (Object.getOwnPropertySymbols) { var symbols = Object.getOwnPropertySymbols(object); enumerableOnly && (symbols = symbols.filter(function (sym) { return Object.getOwnPropertyDescriptor(object, sym).enumerable; })), keys.push.apply(keys, symbols); } return keys; }
...
var StyledBuilderForm = styled_components__WEBPACK_IMPORTED_MODULE_0__["default"].div(_templateObject || (_templateObject = _taggedTemplateLiteral(["\n  display: flex;\n  flex-direction: column;\n\n  label {\n    margin-bottom: 3px;\n  }\n\n  .mwai-builder-row {\n    margin-top: 10px;\n    display: flex;\n    flex-direction: row;\n    align-items: center;\n  }\n\n  .mwai-builder-col {\n    flex: 1;\n    display: flex;\n    flex-direction: column;\n    margin-right: 5px;\n  }\n\n  .mwai-builder-col:last-child {\n    margin-right: 0;\n  }\n\n  pre {\n    white-space: pre-wrap;\n    background: #d4f0ff;\n    color: #037cba;\n    padding: 10px;\n    font-size: 13px;\n    font-weight: bold;\n    margin: 20px 0;\n  }\n\n  .neko-spacer {\n    margin-bottom: 0 !important;\n  }\n\n  .neko-input {\n    border: 1.5px solid #eaeaea !important;\n    background: #fbfbfb !important;\n  }\n\n  .nui-select-option {\n    border: 1.5px solid #eaeaea !important;\n    background: #fbfbfb !important;\n  }\n\n  .nui-checkbox {\n    margin: -6px 0px -2px 0px;\n  }\n"])));
var Settings = function Settings() {
  ...
  var shortcode_imagesbot = options === null || options === void 0 ? void 0 : options.shortcode_imagesbot;
  ...
  var builtShortcode = useMemo(function () {
    var params = [];
    for (var key in shortcodeParams) {
  ...
  console.log({
    shortcodeDefaultParams: shortcodeDefaultParams,
    shortcodeParams: shortcodeParams,
    shortcodeParamsDiff: shortcodeParamsDiff
  });
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            ...
            _context.prev = 2;
            _context.next = 5;
            return (0,_neko_ui__WEBPACK_IMPORTED_MODULE_3__.postFetch)("".concat(_app_settings__WEBPACK_IMPORTED_MODULE_1__.apiUrl, "/update_option"), {
              json: {
                options: newOptions
              },
              nonce: _app_settings__WEBPACK_IMPORTED_MODULE_1__.restNonce
  ...
  var jsxImagesBot = /*#__PURE__*/React.createElement(_neko_ui__WEBPACK_IMPORTED_MODULE_4__.NekoSettings, {
    title: "ImagesBots"
  }, /*#__PURE__*/React.createElement(_neko_ui__WEBPACK_IMPORTED_MODULE_5__.NekoCheckboxGroup, {
    max: "1"
  }, /*#__PURE__*/React.createElement(_neko_ui__WEBPACK_IMPORTED_MODULE_6__.NekoCheckbox, {
    id: "shortcode_imagesbot",
    label: "Enable",
    value: "1",
    checked: shortcode_imagesbot,
  ...
  var jsxOpenAiUsage = /*#__PURE__*/React.createElement(_neko_ui__WEBPACK_IMPORTED_MODULE_4__.NekoSettings, {
    title: "Usage"
  }, !Object.keys(openai_usage).length && /*#__PURE__*/React.createElement(_neko_ui__WEBPACK_IMPORTED_MODULE_8__.NekoTypo, {
    p: true
    ...
    return /*#__PURE__*/React.createElement("li", {
      ...
      var price = null;
      var modelPrice = _constants__WEBPACK_IMPORTED_MODULE_9__.OpenAI_PricingPerModel.find(function (x) {
  ...
  return /*#__PURE__*/React.createElement(_neko_ui__WEBPACK_IMPORTED_MODULE_10__.NekoPage, null, /*#__PURE__*/React.createElement(_CommonStyles__WEBPACK_IMPORTED_MODULE_11__.AiNekoHeader, null), /*#__PURE__*/React.createElement(_neko_ui__WEBPACK_IMPORTED_MODULE_12__.NekoWrapper, null, /*#__PURE__*/React.createElement(_helpers__WEBPACK_IMPORTED_MODULE_2__.OptionsCheck, {
    options: options
  }), /*#__PURE__*/React.createElement(_neko_ui__WEBPACK_IMPORTED_MODULE_12__.NekoColumn, {
    full: true
  }, /*#__PURE__*/React.createElement(_neko_ui__WEBPACK_IMPORTED_MODULE_13__.NekoContainer, null, /*#__PURE__*/React.createElement(_neko_ui__WEBPACK_IMPORTED_MODULE_8__.NekoTypo, {
    p: true
  }, "Boost your WordPress with AI! Don't forget to visit the ", /*#__PURE__*/React.createElement("a", {
    href: "https://meowapps.com/ai-engine/",
    target: "_blank"
  }, "AI Engine website"), " for more information. Have fun! \uD83C\uDFB5")), /*#__PURE__*/React.createElement(_neko_ui__WEBPACK_IMPORTED_MODULE_14__.NekoTabs, {
    ...
    minimal: true
  }, /*#__PURE__*/React.createElement(_neko_ui__WEBPACK_IMPORTED_MODULE_15__.NekoBlock, {
    busy: busy,
    title: "Modules",
    className: "primary"
  }, jsxChatbot, jsxImagesBot, jsxAiFeatures, jsxAiBlocks), /*#__PURE__*/React.createElement(_neko_ui__WEBPACK_IMPORTED_MODULE_15__.NekoBlock, {
    busy: busy,
    title: "Advanced",
    className: "primary"
  }, jsxExtraModels)), /*#__PURE__*/React.createElement(_neko_ui__WEBPACK_IMPORTED_MODULE_12__.NekoColumn, {
    minimal: true
  }, /*#__PURE__*/React.createElement(_neko_ui__WEBPACK_IMPORTED_MODULE_15__.NekoBlock, {
    busy: busy,
    title: "Open AI",
    className: "primary"
  }, jsxOpenAiApiKey, jsxOpenAiUsage)))), shortcode_chat && /*#__PURE__*/React.createElement(_neko_ui__WEBPACK_IMPORTED_MODULE_14__.NekoTab, {
    title: "Chatbot"
  }, /*#__PURE__*/React.createElement(_neko_ui__WEBPACK_IMPORTED_MODULE_12__.NekoWrapper, null, /*#__PURE__*/React.createElement(_neko_ui__WEBPACK_IMPORTED_MODULE_12__.NekoColumn, {
    minimal: true
  }, /*#__PURE__*/React.createElement(_neko_ui__WEBPACK_IMPORTED_MODULE_15__.NekoBlock, {
    ...
    title: "Features",
    className: "primary"
  }, jsxShortcodeFormatting, jsxShortcodeSyntaxHighlighting), /*#__PURE__*/React.createElement(_neko_ui__WEBPACK_IMPORTED_MODULE_15__.NekoBlock, {
    className: "primary"
  }, /*#__PURE__*/React.createElement(_neko_ui__WEBPACK_IMPORTED_MODULE_8__.NekoTypo, {
    p: true
  }, "You can create a chatbot by using this shortcode anywhere on your website: ", /*#__PURE__*/React.createElement("br", null), /*#__PURE__*/React.createElement("br", null), /*#__PURE__*/React.createElement("b", null, "[mwai_chat context=\"Converse as if you were Michael Jackson, talking from the afterlife.\" ai_name=\"Michael: \" user_name=\"You: \" start_sentence=\"Hi, my friend.\"]"), /*#__PURE__*/React.createElement("br", null), /*#__PURE__*/React.createElement("br", null), "You can specify various parameters, such as the temperature and the model. You can also use the shortcode builder! \uD83C\uDFB5 There are default parameters set automatically, so don't hesitate to try the shortcode [mwai_chat] by itself."))), /*#__PURE__*/React.createElement(_neko_ui__WEBPACK_IMPORTED_MODULE_12__.NekoColumn, {
    minimal: true
  }, /*#__PURE__*/React.createElement(_neko_ui__WEBPACK_IMPORTED_MODULE_15__.NekoBlock, {
    busy: busy,
    title: "Chatbot Shortcode Builder",
    className: "primary",
    action: /*#__PURE__*/React.createElement(_neko_ui__WEBPACK_IMPORTED_MODULE_16__.NekoButton, {
      className: "danger",
      onClick: onResetShortcodeParams
    }, "Reset Parameters")
  }, /*#__PURE__*/React.createElement("p", null, "Generate shortcodes here and paste them anywhere on your website! If you choose to \"Set as Default Parameters\", the parameters you set here will be used by default (but overridable in the shortcode). You can also choose to inject this set of parameters directly on your whole website, if you only need one chatbot."), /*#__PURE__*/React.createElement(StyledBuilderForm, null, /*#__PURE__*/React.createElement("label", null, "Context:"), /*#__PURE__*/React.createElement(_neko_ui__WEBPACK_IMPORTED_MODULE_7__.NekoInput, {
    id: "context",
    name: "context",
    ...
    className: "mwai-builder-col"
  }, /*#__PURE__*/React.createElement("label", null, "Start Sentence (", shortcodeParams.ai_name, "):"), /*#__PURE__*/React.createElement(_neko_ui__WEBPACK_IMPORTED_MODULE_7__.NekoInput, {
    id: "start_sentence",
    name: "start_sentence",
    ...
    className: "mwai-builder-col"
  }, /*#__PURE__*/React.createElement("label", null, "Input placeholder:"), /*#__PURE__*/React.createElement(_neko_ui__WEBPACK_IMPORTED_MODULE_7__.NekoInput, {
    ...
    className: "mwai-builder-col"
  }, /*#__PURE__*/React.createElement("label", null, "Button text:"), /*#__PURE__*/React.createElement(_neko_ui__WEBPACK_IMPORTED_MODULE_7__.NekoInput, {
    id: "text_send",
    name: "text_send",
  ...
  }, /*#__PURE__*/React.createElement("label", null, "Style:")), /*#__PURE__*/React.createElement("div", {
    className: "mwai-builder-col"
  }, /*#__PURE__*/React.createElement(_neko_ui__WEBPACK_IMPORTED_MODULE_18__.NekoSelect, {
    scrolldown: true,
    id: "style",
    name: "style",
  ...
  }, /*#__PURE__*/React.createElement("label", null, "Model:"), /*#__PURE__*/React.createElement(_neko_ui__WEBPACK_IMPORTED_MODULE_18__.NekoSelect, {
    scrolldown: true,
    id: "model",
    name: "model",
    ...
    return /*#__PURE__*/React.createElement(_neko_ui__WEBPACK_IMPORTED_MODULE_18__.NekoOption, {
      value: x.id,
      label: x.name
    });
  }))), /*#__PURE__*/React.createElement("div", {
    ...
    id: "casually_fined_tuned",
    label: "Yes",
    checked: shortcodeParams.casually_fined_tuned,
    value: "1",
    onChange: updateShortcodeParams
    ...
    label: "Inject this chatbot on this website",
    value: "1",
    checked: shortcodeChatInject,
    description: /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("span", null, "Inject the chatbot automatically on your website. It will be available on every page."), shortcodeParams.window ? '' : /*#__PURE__*/React.createElement("span", null, "It's highly recommended to enable 'Window (Popup Mode)'")),
    onChange: updateOption
  }))))), (shortcode_chat || shortcode_imagesbot) && /*#__PURE__*/React.createElement(_neko_ui__WEBPACK_IMPORTED_MODULE_14__.NekoTab, {
    title: "ImagesBot"
  }, /*#__PURE__*/React.createElement(_neko_ui__WEBPACK_IMPORTED_MODULE_12__.NekoWrapper, null, /*#__PURE__*/React.createElement(_neko_ui__WEBPACK_IMPORTED_MODULE_12__.NekoColumn, {
    minimal: true
  }, /*#__PURE__*/React.createElement(_neko_ui__WEBPACK_IMPORTED_MODULE_15__.NekoBlock, {
    ...
    p: true
  }, "Just like the chatbot, you can create an ImagesBot by using this shortcode anywhere on your website: ", /*#__PURE__*/React.createElement("br", null), /*#__PURE__*/React.createElement("br", null), /*#__PURE__*/React.createElement("b", null, "[mwai_imagesbot ai_name=\"AI: \" user_name=\"You: \" start_sentence=\"Hey there! Can you tell me what kind of images you need?\" max_results=\"6\"]"), /*#__PURE__*/React.createElement("br", null), /*#__PURE__*/React.createElement("br", null), "There are no options yet for this shortcode, styles are automatically applied."))))), /*#__PURE__*/React.createElement(_neko_ui__WEBPACK_IMPORTED_MODULE_14__.NekoTab, {
    title: "Fine Tuning: Train your AI"
  }, /*#__PURE__*/React.createElement(_FineTuning__WEBPACK_IMPORTED_MODULE_19__["default"], {
    options: options,
...
var useModels = function useModels(options) {
  ...
  var models = useMemo(function () {
    var _extraModels;
    var allModels = _constants__WEBPACK_IMPORTED_MODULE_2__.OpenAI_models;
...
/* harmony import */ var _common__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! @common */ "./common/js/dashboard/Dashboard.js");
...
/* harmony import */ var _app_components_Playground__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! @app/components/Playground */ "./app/js/components/Playground.js");
/* harmony import */ var _components_PostsListTools__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./components/PostsListTools */ "./app/js/components/PostsListTools.js");
/* harmony import */ var _components_ContentGenerator__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./components/ContentGenerator */ "./app/js/components/ContentGenerator.js");
/* harmony import */ var _components_ImageGenerator__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./components/ImageGenerator */ "./app/js/components/ImageGenerator.js");
/* harmony import */ var _components_SlotFills__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./components/SlotFills */ "./app/js/components/SlotFills.js");
...
document.addEventListener('DOMContentLoaded', function (event) {
  (0,_components_SlotFills__WEBPACK_IMPORTED_MODULE_1__["default"])();

  // Settings
  var settings = document.getElementById('mwai-admin-settings');
  if (settings) {
    render( /*#__PURE__*/React.createElement(_tanstack_react_query__WEBPACK_IMPORTED_MODULE_2__.QueryClientProvider, {
      client: queryClient
    }, /*#__PURE__*/React.createElement(_app_components_Settings__WEBPACK_IMPORTED_MODULE_3__["default"], null)), settings);
  }

  // Content Generator
  var generator = document.getElementById('mwai-content-generator');
  if (generator) {
    render( /*#__PURE__*/React.createElement(_components_ContentGenerator__WEBPACK_IMPORTED_MODULE_4__["default"], null), generator);
  }

  // Image Generator
  var imgGen = document.getElementById('mwai-image-generator');
  if (imgGen) {
    render( /*#__PURE__*/React.createElement(_components_ImageGenerator__WEBPACK_IMPORTED_MODULE_5__["default"], null), imgGen);
  }

  // Dashboard
  var dashboard = document.getElementById('mwai-playground');
  if (dashboard) {
    render( /*#__PURE__*/React.createElement(_app_components_Playground__WEBPACK_IMPORTED_MODULE_6__["default"], null), dashboard);
  }

  // Admin Tools
  var postsListTools = document.getElementById('mwai-admin-postsList');
  if (postsListTools) {
    render( /*#__PURE__*/React.createElement(_components_PostsListTools__WEBPACK_IMPORTED_MODULE_7__["default"], null), postsListTools);
  }

  // Common
  var meowDashboard = document.getElementById('meow-common-dashboard');
  if (meowDashboard) {
    render( /*#__PURE__*/React.createElement(_common__WEBPACK_IMPORTED_MODULE_8__.Dashboard, null), meowDashboard);
  }
});
