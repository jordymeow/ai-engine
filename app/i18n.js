...
i18n.COMMON = {
  ...
  EMPTY_HINT: __( 'Empty State Hint', 'ai-engine' ),
  EMPTY_HINT_PLACEHOLDER: __( 'Ask me anything!', 'ai-engine' ),
  ...
  THEME_EDIT_HINT: __( 'Colors, fonts, sizes and custom CSS belong to the theme.', 'ai-engine' ),
  THEME_EDIT_LINK: __( 'Customize this theme', 'ai-engine' ),
  CHATBOT_DELETE_TITLE: __( 'Delete this chatbot?', 'ai-engine' ),
  CHATBOT_DELETE_CONFIRM: __( 'The chatbot "{NAME}" and all its settings will be removed. Shortcodes using its ID will stop working. This cannot be undone.', 'ai-engine' ),
  CHATBOT_RESET_TITLE: __( 'Reset this chatbot?', 'ai-engine' ),
  CHATBOT_RESET_CONFIRM: __( 'Every setting of "{NAME}" (instructions, model, appearance, functions) goes back to its default value. Its name and ID are kept. This cannot be undone.', 'ai-engine' ),
  THEME_DELETE_TITLE: __( 'Delete this theme?', 'ai-engine' ),
  THEME_DELETE_CONFIRM: __( 'The theme "{NAME}" and its CSS will be removed. Chatbots using it will need another theme. This cannot be undone.', 'ai-engine' ),
  THEME_RESET_TITLE: __( 'Reset this theme?', 'ai-engine' ),
  THEME_RESET_CONFIRM: __( 'Every colour, size and line of custom CSS of "{NAME}" will be cleared. This cannot be undone.', 'ai-engine' ),
...
i18n.HELP = {
  ...
  RESOLVE_SHORTCODE: __( 'Renders the shortcodes and the page builder layouts in your content before it is read (by Content-Aware and by Knowledge). Needed if your pages are made with a builder that keeps its content outside the editor, like Breakdance, Oxygen or Bricks.', 'ai-engine' ),
  ...
  EMPTY_HINT: __( 'Shown under the avatar when the conversation is empty and there is no first message. Leave it empty for the default, which is translated.', 'ai-engine' ),
};
...
i18n.MCP_CONNECT = {
  TITLE: __( 'Connect an AI assistant', 'ai-engine' ),
  SUBTITLE: __( 'Let Claude, ChatGPT or any AI assistant work on this site.', 'ai-engine' ),
  BADGE_DIRECT: __( 'Direct, no relay', 'ai-engine' ),
  BADGE_CREDENTIALS: __( 'Credentials stay here', 'ai-engine' ),
  BADGE_FREE: __( 'Free, no cap', 'ai-engine' ),
  CHECKING: __( 'Checking your host…', 'ai-engine' ),
  HOST_OK: __( 'Your site is ready to connect', 'ai-engine' ),
  HOST_UNKNOWN: __( 'The host check could not run', 'ai-engine' ),
  HOST_NOT_CHECKED: __( 'Host not checked yet', 'ai-engine' ),
  RECHECK: __( 'Re-check', 'ai-engine' ),
  COPY: __( 'Copy', 'ai-engine' ),
  COPIED: __( 'Copied', 'ai-engine' ),
  COPY_FOR_HOST: __( 'Ask your host to fix it', 'ai-engine' ),
  SHOW_DETAILS: __( 'Show details', 'ai-engine' ),
  HIDE_DETAILS: __( 'Hide details', 'ai-engine' ),
  OTHER: __( 'Other', 'ai-engine' ),
  STEP_COPY_URL: __( 'Copy the URL', 'ai-engine' ),
  STEP_COPY_COMMAND: __( 'Copy the command, run it in a terminal', 'ai-engine' ),
  STEP_CONNECTED: __( 'Connected', 'ai-engine' ),
  TIMED_OUT: __( 'Still not connected? Check the steps, then copy the URL again.', 'ai-engine' ),
  SETTINGS: __( 'Settings', 'ai-engine' ),
  HOW_IT_WORKS: __( 'How it works', 'ai-engine' ),
  /* translators: %s: the AI assistant being connected, like Claude or ChatGPT */
  WAITING: __( 'Waiting for %s…', 'ai-engine' ),
  /* translators: %s: the name of the assistant that just connected */
  CONNECTED: __( '%s is connected', 'ai-engine' ),
  YOUR_APP: __( 'Your assistant', 'ai-engine' ),
  /* translators: %s: the WordPress user the assistant connected as */
  CONNECTED_AS: __( 'As %s, just now.', 'ai-engine' ),
  TRY_ASKING: __( 'Try asking it', 'ai-engine' ),
  // Read-only on purpose: the first thing someone asks should not change their site.
  TRY_QUESTIONS: [
    __( 'Which of my posts needs a better title?', 'ai-engine' ),
    __( 'What were my last five posts about?', 'ai-engine' ),
    __( 'Which of my pages have no featured image?', 'ai-engine' ),
    __( 'Summarize the comments waiting for moderation.', 'ai-engine' ),
    __( 'Which drafts have I left unfinished?', 'ai-engine' ),
    __( 'What are my most used categories and tags?', 'ai-engine' ),
    __( 'Which older posts could link to my latest one?', 'ai-engine' ),
    __( 'Suggest three post ideas based on what I have written.', 'ai-engine' ),
  ],
  ANOTHER_IDEA: __( 'Another idea', 'ai-engine' ),
  CONNECT_ANOTHER: __( 'Connect another one', 'ai-engine' ),
  NO_CONNECTION: __( 'Nothing connected yet', 'ai-engine' ),
  MANAGE: __( 'Who\'s connected →', 'ai-engine' ),
  CLAUDE_ADD: __( 'Add it in Claude', 'ai-engine' ),
  CLAUDE_ADD_LINK: __( 'Open Connectors', 'ai-engine' ),
  CLAUDE_ADD_DETAIL: __( 'Click Add, then Add custom connector. Paste the URL and choose Sign in now.', 'ai-engine' ),
  CLAUDE_APPROVE_DETAIL: __( 'Claude opens a page on this site: sign in and click Approve.', 'ai-engine' ),
  CHATGPT_ADD: __( 'Add it in ChatGPT', 'ai-engine' ),
  CHATGPT_ADD_DETAIL: __( 'Turn on Developer mode in Settings → Security and login. Then in Plugins, click +, paste the URL and choose OAuth.', 'ai-engine' ),
  CHATGPT_SIGN_IN: __( 'Sign in, then Refresh', 'ai-engine' ),
  CHATGPT_SIGN_IN_DETAIL: __( 'Open the plugin, click Sign in and Approve, then Refresh so the tools appear.', 'ai-engine' ),
  CODE_MCP: __( 'Run /mcp in Claude Code', 'ai-engine' ),
  CODE_MCP_DETAIL: __( 'Pick this server and authenticate: your browser opens this site to approve.', 'ai-engine' ),
  OTHER_ADD: __( 'Add it as a remote MCP server', 'ai-engine' ),
  OTHER_ADD_DETAIL: __( 'Choose Streamable HTTP with OAuth. Most assistants discover the rest from the URL.', 'ai-engine' ),
  OTHER_APPROVE_DETAIL: __( 'It opens a page on this site: sign in and click Approve.', 'ai-engine' ),
  APPROVE: __( 'Approve in WordPress', 'ai-engine' ),
  APPROVE_DETAIL: __( 'Sign in and click Approve.', 'ai-engine' ),
  V_UA_TITLE: __( 'Your host blocks Claude', 'ai-engine' ),
  V_UA_SUMMARY: __( 'Its firewall rejects the requests Claude sends, so Claude cannot connect yet.', 'ai-engine' ),
  V_POST_TITLE: __( 'Your host blocks Claude\'s requests', 'ai-engine' ),
  V_POST_SUMMARY: __( 'Claude can find this site, but the firewall blocks its sign-in and its tool calls.', 'ai-engine' ),
  V_AI_TITLE: __( 'AI assistants are blocked', 'ai-engine' ),
  V_AI_SUMMARY: __( 'They are turned away by name, often by Cloudflare\'s AI bot blocking (Security → Bots). Allow them there.', 'ai-engine' ),
  V_WELLKNOWN_TITLE: __( 'The sign-in discovery is blocked', 'ai-engine' ),
  V_WELLKNOWN_SUMMARY: __( 'The server stops /.well-known/ requests before WordPress sees them.', 'ai-engine' ),
  V_NESTED_SUMMARY: __( 'A second .htaccess inside the .well-known folder stops the requests before WordPress.', 'ai-engine' ),
  V_CACHE_TITLE: __( 'A cache is serving an old error', 'ai-engine' ),
  V_CACHE_SUMMARY: __( 'WordPress answers correctly, but a page cache keeps an old 404. Purge your cache.', 'ai-engine' ),
  V_STATUS_TITLE: __( 'Your host answers in an unexpected way', 'ai-engine' ),
  V_STATUS_SUMMARY: __( 'The check got a response it did not expect. The details say which.', 'ai-engine' ),
  /* translators: %s: the MCP endpoint URL of this site */
  HOST_MESSAGE: __( 'Hello! I am connecting AI assistants (Claude, ChatGPT) to my WordPress site through its MCP server at %s. Requests sent with the User-Agent "python-httpx" to /.well-known/oauth-* and /wp-json/mcp/v1/* are blocked before they reach WordPress. Could you allow them for this site? Thank you!', 'ai-engine' ),
};
